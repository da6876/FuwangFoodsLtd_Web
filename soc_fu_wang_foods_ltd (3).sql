...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2021 at 03:24 PM
...
--
-- Database: `soc_fu_wang_foods_ltd`
--
...
CREATE TABLE `area_info` (
  ...
  `area_status` varchar(10) NOT NULL DEFAULT 'N'
...
INSERT INTO `area_info` (`area_code`, `area_name`, `thana_id`, `area_status`) VALUES
(13, 'Mirpur-1', 309, 'Active'),
(14, 'Mirpur-2', 309, 'Active'),
(15, 'Mirpur-6', 309, 'Active'),
(16, 'Mirpur-7', 309, 'Active'),
(17, 'Mirpur-10', 309, 'Active'),
(18, 'Mirpur-11', 309, 'Active'),
(19, 'Mirpur-12', 309, 'Active'),
(20, 'Mirpur-13', 309, 'Active'),
(21, 'Mirpur-14', 309, 'Active');
...
(11440000, 'Categories', 'A', '2021-10-03 14:59:26'),
(11440001, 'Categories 2', 'A', '2021-10-03 15:00:01'),
(11440002, 'Categories 3', 'I', '2021-10-03 15:19:47'),
(11440005, 'Categories', 'A', '2021-10-03 15:40:56'),
(11440007, 'AAA', 'A', '2021-10-08 18:29:21');
...
CREATE TABLE `categories_sub` (
  ...
  `sub_categories_name` varchar(50) DEFAULT NULL,
  `sub_categories_status` varchar(10) NOT NULL DEFAULT 'N',
  `create_info` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `categories_sub` (`sub_categories_id`, `categories_id`, `sub_categories_name`, `sub_categories_status`, `create_info`) VALUES
(11550000, 11440000, 'AAA', 'A', '2021-10-03 15:40:43'),
(11550001, 11440000, 'Sub Categories', 'A', '2021-10-03 15:41:51'),
(11550002, 11440000, 'Sub Categories 1', 'A', '2021-10-03 15:41:57'),
(11550003, 11440000, 'Sub Categories 2', 'I', '2021-10-03 15:42:14'),
(11550004, 11440001, 'Bread', 'A', '2021-10-03 17:11:35'),
(11550005, 11440001, 'AAA', 'A', '2021-10-08 18:29:35');

-- --------------------------------------------------------

--
-- Table structure for table `db_point_info`
--

CREATE TABLE `db_point_info` (
  `db_point_id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `shop_name` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shop_own_name` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobile_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shop_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `trade_lic_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `web_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `area_code` int(10) UNSIGNED DEFAULT NULL,
  `db_point_status` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `create_info` datetime NOT NULL DEFAULT current_timestamp(),
  `update_info` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `db_point_info`
--

INSERT INTO `db_point_info` (`db_point_id`, `user_id`, `shop_name`, `shop_own_name`, `mobile_no`, `shop_image`, `email`, `trade_lic_no`, `web_address`, `address`, `area_code`, `db_point_status`, `create_info`, `update_info`) VALUES
(3, 1315007287, 'Adida Store', 'Robin Williams', '01369988887', 'E:xampphtdocsfu_wangfoodsltddb_point_image/01369988887_DB_Point.jpg', 'srleclipsel', '2580009999', '', 'Kollapur,Dhaka', 13, 'P', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 1315007287, 'Ashik Shop', 'Ashik', '01979798788', 'E:xampphtdocsfu_wangfoodsltddb_point_image/01979798788_DB_Point.jpg', 'ashik@gmail', '6797997979', '', '1,Chamelibagh, Bangladesh', 14, 'P', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `order_info` (
  ...
  `order_trck` varchar(50) NOT NULL,
  `db_point_id` int(10) NOT NULL,
  `db_point_image` varchar(150) DEFAULT NULL,
  `user_info_id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL,
  `order_qnty` varchar(50) DEFAULT NULL,
  `order_rate` varchar(50) DEFAULT NULL,
...
INSERT INTO `order_info` (`order_info_id`, `order_trck`, `db_point_id`, `db_point_image`, `user_info_id`, `product_id`, `order_qnty`, `order_rate`, `order_amount`, `order_date`, `order_time`, `delivery_date`, `delivery_time`, `latitude`, `longitude`, `create_info`, `update_info`) VALUES
(110880022, 'WeGP7a9U47_20211022183112', 11, 'C:xampphtdocsFuwangFoodsLtdpublicallImagesdb_point_order_image/11_DB_Point.jpg', 22, 233, '23', '12', '33', '22/10/2021', '06:15', '25/10/2021', '11:20', '23.66666', '90.3333', '2021-10-22 18:31:12', NULL),
(110880023, '53Nu5Dr2xG4zA2QAdc50_20211022183512', 11, 'C:xampphtdocsFuwangFoodsLtdpublicallImagesdb_point_order_image/11_DB_Point.jpg', 22, 233, '23', '12', '33', '22/10/2021', '06:15', '25/10/2021', '11:20', '23.66666', '90.3333', '2021-10-22 18:35:12', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `order_info_dtl`
--

CREATE TABLE `order_info_dtl` (
  `order_info_dtl_id` int(25) NOT NULL,
  `order_info_id` int(11) NOT NULL,
  `product_id` int(10) NOT NULL,
  `order_qnty` varchar(50) DEFAULT NULL,
  `order_rate` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `order_info_mst`
--

CREATE TABLE `order_info_mst` (
  `order_info_id` int(25) NOT NULL,
  `order_trck` varchar(50) NOT NULL,
  `db_point_id` int(10) NOT NULL,
  `db_point_image` varchar(150) DEFAULT NULL,
  `user_info_id` int(10) NOT NULL,
...
--
-- Dumping data for table `order_info_mst`
--
...
(11880044, 'ItlwNKfXd8y6numnCbG2_20211024170732', 3, 'public/allImages/db_point_order_image/3_DB_Point_img_20211024_170732.jpg', 11220009, '2021-10-24', '', '23.2222', '92.252222', '2021-10-24 17:07:32', NULL),
(11880045, '9y1fmEWLqnG3M6MPT4vt_20211024170946', 3, 'public/allImages/db_point_order_image/3_DB_Point_img_20211024_170946.jpg', 11220009, '2021-10-23', '', '23.2222', '92.252222', '2021-10-24 17:09:46', NULL),
(11880046, 'bjTbfawud4HL2tkKT9pm_20211024171044', 3, 'public/allImages/db_point_order_image/3_DB_Point_img_20211024_171044.jpg', 11220009, '2021-10-24', '', '23.2222', '92.252222', '2021-10-24 17:10:44', NULL);
...
INSERT INTO `product_info` (`product_id`, `product_name`, `product_type_id`, `Categorie_id`, `sub_Categorie_id`, `shot_decs`, `decs`, `Gm`, `Pcs_Per_Ctn`, `dp_unit`, `rp_unit`, `mrp_unit`, `product_sku_code`, `product_image`, `product_status`, `create_by`, `update_by`, `create_info`, `update_info`) VALUES
(11660003, 'Butter Bun', 11330000, 11440000, 11550001, 'Butter Bun', 'Butter Bun', '40', '100', 5, 5, 6, 'FFLTD_SKU110001', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660004, 'Custard Bun ', 11330000, 11440000, 11550001, 'Custard Bun ', 'Custard Bun ', '40', '72', 5, 6, 8, 'FFLTD_SKU110002', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660005, 'Daily Bread ', 11330000, 11440000, 11550001, 'Daily Bread ', 'Daily Bread ', '105', '48', 8, 8, 10, 'FFLTD_SKU110003', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660006, 'Delicious Bread ', 11330000, 11440000, 11550001, 'Delicious Bread ', 'Delicious Bread ', '230', '30', 16, 18, 20, 'FFLTD_SKU110004', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660007, 'Econo Sweet Bread ', 11330000, 11440000, 11550001, 'Econo Sweet Bread ', 'Econo Sweet Bread ', '40', '72', 5, 6, 7, 'FFLTD_SKU110005', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660008, 'Family Bread', 11330000, 11440000, 11550001, 'Family Bread', 'Family Bread', '350', '20', 25, 27, 35, 'FFLTD_SKU110006', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660009, 'Honey Mix', 11330000, 11440000, 11550001, 'Honey Mix', 'Honey Mix', '50', '36', 9, 10, 12, 'FFLTD_SKU110007', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660010, 'Medium Bread', 11330000, 11440000, 11550001, 'Medium Bread', 'Medium Bread', '150', '30', 12, 13, 15, 'FFLTD_SKU110008', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660011, 'Milky Bread ', 11330000, 11440000, 11550001, 'Milky Bread ', 'Milky Bread ', '340', '12', 31, 34, 40, 'FFLTD_SKU110009', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660012, 'Milky Bread ', 11330000, 11440000, 11550001, 'Milky Bread ', 'Milky Bread ', '700', '6', 52, 58, 70, 'FFLTD_SKU110010', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660013, 'Mercury Bread', 11330000, 11440000, 11550001, 'Mercury Bread', 'Mercury Bread', '85', '48', 7, 8, 10, 'FFLTD_SKU110011', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660014, 'Platinum Sandwich Bread', 11330000, 11440000, 11550001, 'Platinum Sandwich Bread', 'Platinum Sandwich Bread', '700', '12', 45, 50, 60, 'FFLTD_SKU110012', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660015, 'Special Bread ', 11330000, 11440000, 11550001, 'Special Bread ', 'Special Bread ', '520', '16', 35, 38, 45, 'FFLTD_SKU110013', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660016, 'Sweet Bread', 11330000, 11440000, 11550001, 'Sweet Bread', 'Sweet Bread', '65', '72', 7, 7, 9, 'FFLTD_SKU110014', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660017, 'Tiffn Bread', 11330000, 11440000, 11550001, 'Tiffn Bread', 'Tiffn Bread', '50', '96', 5, 5, 6, 'FFLTD_SKU110015', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660018, 'Sandwich Bread', 11330000, 11440000, 11550001, 'Sandwich Bread', 'Sandwich Bread', '300', '12', 28, 30, 35, 'FFLTD_SKU110016', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660019, 'Vanila Butter Bun', 11330000, 11440000, 11550001, 'Vanila Butter Bun', 'Vanila Butter Bun', '40', '72', 8, 8, 10, 'FFLTD_SKU110017', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660020, 'YoYo Wafer (Strawberry)', 11330000, 11440000, 11550001, 'YoYo Wafer (Strawberry)', 'YoYo Wafer (Strawberry)', '16', '144', 4, 4, 5, 'FFLTD_SKU110018', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660021, 'YoYo Wafer (Vanila)', 11330000, 11440000, 11550001, 'YoYo Wafer (Vanila)', 'YoYo Wafer (Vanila)', '16', '144', 4, 4, 5, 'FFLTD_SKU110019', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660022, 'Salted Biscuits', 11330000, 11440000, 11550001, 'Salted Biscuits', 'Salted Biscuits', '50', '60', 7, 8, 10, 'FFLTD_SKU110020', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660023, 'Dia Salt Biscuit', 11330000, 11440000, 11550001, 'Dia Salt Biscuit', 'Dia Salt Biscuit', '400', '12', 50, 55, 65, 'FFLTD_SKU110021', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660024, 'Econo Dia Salt Biscuit ', 11330000, 11440000, 11550001, 'Econo Dia Salt Biscuit ', 'Econo Dia Salt Biscuit ', '125', '24', 18, 20, 25, 'FFLTD_SKU110022', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660025, 'Dia Salt Biscuit Blue', 11330000, 11440000, 11550001, 'Dia Salt Biscuit Blue', 'Dia Salt Biscuit Blue', '400', '12', 50, 55, 65, 'FFLTD_SKU110023', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660026, 'Fu-Wang Reo Biscuit', 11330000, 11440000, 11550001, 'Fu-Wang Reo Biscuit', 'Fu-Wang Reo Biscuit', '180', '12', 45, 50, 60, 'FFLTD_SKU110024', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660027, 'Fu-Wang Biscut Tube(Big) Baym', 11330000, 11440000, 11550001, 'Fu-Wang Biscut Tube(Big) Baym', 'Fu-Wang Biscut Tube(Big) Baym', '1800', '5', 220, 240, 300, 'FFLTD_SKU110025', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660028, 'Horlicks Biscuits ', 11330000, 11440000, 11550001, 'Horlicks Biscuits ', 'Horlicks Biscuits ', '320', '12', 45, 50, 60, 'FFLTD_SKU110026', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660029, 'Milk Marie Biscuit', 11330000, 11440000, 11550001, 'Milk Marie Biscuit', 'Milk Marie Biscuit', '290', '6', 36, 40, 50, 'FFLTD_SKU110027', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660030, 'Namkin Biscuite', 11330000, 11440000, 11550001, 'Namkin Biscuite', 'Namkin Biscuite', '320', '12', 45, 50, 60, 'FFLTD_SKU110028', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660031, 'New Nutritious Biscuit (Poly)', 11330000, 11440000, 11550001, 'New Nutritious Biscuit (Poly)', 'New Nutritious Biscuit (Poly)', '75', '48', 11, 12, 15, 'FFLTD_SKU110029', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660032, 'Cookies Biscuit', 11330000, 11440000, 11550001, 'Cookies Biscuit', 'Cookies Biscuit', '350', '12', 50, 55, 65, 'FFLTD_SKU110030', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660033, 'First Love Biscuit ', 11330000, 11440000, 11550001, 'First Love Biscuit ', 'First Love Biscuit ', '45', '24', 8, 8, 10, 'FFLTD_SKU110031', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660034, 'Signature Salted Biscuit', 11330000, 11440000, 11550001, 'Signature Salted Biscuit', 'Signature Salted Biscuit', '270', '12', 36, 40, 50, 'FFLTD_SKU110032', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660035, 'Signature Cream Roll', 11330000, 11440000, 11550001, 'Signature Cream Roll', 'Signature Cream Roll', '280', '12', 70, 78, 95, 'FFLTD_SKU110033', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660036, 'Signature Cream Roll Lunch Box', 11330000, 11440000, 11550001, 'Signature Cream Roll Lunch Box', 'Signature Cream Roll Lunch Box', '270', '12', 58, 64, 80, 'FFLTD_SKU110034', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660037, 'Signature Cream Roll', 11330000, 11440000, 11550001, 'Signature Cream Roll', 'Signature Cream Roll', '270', '12', 52, 58, 72, 'FFLTD_SKU110035', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660038, 'Milk Plus Biscuit', 11330000, 11440000, 11550001, 'Milk Plus Biscuit', 'Milk Plus Biscuit', '140', '12', 22, 24, 30, 'FFLTD_SKU110036', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660039, 'Chocolate Love Biscuit', 11330000, 11440000, 11550001, 'Chocolate Love Biscuit', 'Chocolate Love Biscuit', '65', '12', 14, 15, 20, 'FFLTD_SKU110037', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660040, 'Twitter Biscuit', 11330000, 11440000, 11550001, 'Twitter Biscuit', 'Twitter Biscuit', '25', '72', 4, 4, 5, 'FFLTD_SKU110038', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660041, 'Signature Orange Biscuit', 11330000, 11440000, 11550001, 'Signature Orange Biscuit', 'Signature Orange Biscuit', '60', '48', 7, 8, 10, 'FFLTD_SKU110039', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660042, 'Butter Delight Biscuit', 11330000, 11440000, 11550001, 'Butter Delight Biscuit', 'Butter Delight Biscuit', '180', '12', 46, 50, 60, 'FFLTD_SKU110040', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660043, 'Chocho Delight Biscuit', 11330000, 11440000, 11550001, 'Chocho Delight Biscuit', 'Chocho Delight Biscuit', '180', '12', 46, 50, 60, 'FFLTD_SKU110041', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660044, 'Choco Toast', 11330000, 11440000, 11550001, 'Choco Toast', 'Choco Toast', '35', '96', 6, 7, 8, 'FFLTD_SKU110042', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660045, 'Fu-Wang Toast ', 11330000, 11440000, 11550001, 'Fu-Wang Toast ', 'Fu-Wang Toast ', '350', '12', 36, 40, 50, 'FFLTD_SKU110043', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660046, 'Misty Toast', 11330000, 11440000, 11550001, 'Misty Toast', 'Misty Toast', '350', '12', 45, 50, 60, 'FFLTD_SKU110044', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660047, 'Non Stop Crispy Toast', 11330000, 11440000, 11550001, 'Non Stop Crispy Toast', 'Non Stop Crispy Toast', '200', '36', 19, 21, 25, 'FFLTD_SKU110045', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660048, 'Crunchy Ghee Toast', 11330000, 11440000, 11550001, 'Crunchy Ghee Toast', 'Crunchy Ghee Toast', '200', '36', 19, 21, 25, 'FFLTD_SKU110046', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660049, 'Sandwich Toast', 11330000, 11440000, 11550001, 'Sandwich Toast', 'Sandwich Toast', '35', '96', 6, 7, 8, 'FFLTD_SKU110047', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660050, 'Miu Miu Toast', 11330000, 11440000, 11550001, 'Miu Miu Toast', 'Miu Miu Toast', '30', '48', 7, 8, 10, 'FFLTD_SKU110048', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660051, 'Sweet Toast', 11330000, 11440000, 11550001, 'Sweet Toast', 'Sweet Toast', '130', '24', 16, 17, 20, 'FFLTD_SKU110049', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660052, 'Sweet Toast Premium', 11330000, 11440000, 11550001, 'Sweet Toast Premium', 'Sweet Toast Premium', '370', '12', 45, 50, 60, 'FFLTD_SKU110050', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660053, 'GarlicToast', 11330000, 11440000, 11550001, 'GarlicToast', 'GarlicToast', '150', '36', 31, 34, 40, 'FFLTD_SKU110051', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660054, 'Fu-Wang Daily Toast', 11330000, 11440000, 11550001, 'Fu-Wang Daily Toast', 'Fu-Wang Daily Toast', '300', '12', 38, 42, 50, 'FFLTD_SKU110052', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660055, 'Laschcha Shemai', 11330000, 11440000, 11550001, 'Laschcha Shemai', 'Laschcha Shemai', '180', '25', 24, 26, 35, 'FFLTD_SKU110053', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660056, 'Normal Toast', 11330000, 11440000, 11550001, 'Normal Toast', 'Normal Toast', '300', '12', 36, 40, 50, 'FFLTD_SKU110054', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660057, 'Spicy Toast', 11330000, 11440000, 11550001, 'Spicy Toast', 'Spicy Toast', '150', '36', 23, 25, 30, 'FFLTD_SKU110055', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660058, 'Premium Spicy Toast', 11330000, 11440000, 11550001, 'Premium Spicy Toast', 'Premium Spicy Toast', '150', '36', 23, 25, 30, 'FFLTD_SKU110056', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660059, 'Jerry Cake', 11330000, 11440000, 11550001, 'Jerry Cake', 'Jerry Cake', '12', '96', 4, 4, 5, 'FFLTD_SKU110057', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660060, 'Mega Jerry Cake', 11330000, 11440000, 11550001, 'Mega Jerry Cake', 'Mega Jerry Cake', '25', '72', 7, 8, 10, 'FFLTD_SKU110058', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660061, 'Lemon Cake ', 11330000, 11440000, 11550001, 'Lemon Cake ', 'Lemon Cake ', '40', '', 11, 12, 15, 'FFLTD_SKU110059', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660062, 'American Cheese Cake', 11330000, 11440000, 11550001, 'American Cheese Cake', 'American Cheese Cake', '400', '6', 72, 80, 100, 'FFLTD_SKU110060', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660063, 'Anytime Slice Cake (B)', 11330000, 11440000, 11550001, 'Anytime Slice Cake (B)', 'Anytime Slice Cake (B)', '90', '32', 19, 21, 25, 'FFLTD_SKU110061', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660064, 'Anytime Slice Cake (S)', 11330000, 11440000, 11550001, 'Anytime Slice Cake (S)', 'Anytime Slice Cake (S)', '50', '48', 11, 13, 15, 'FFLTD_SKU110062', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660065, 'Chocoletto Slice Cake', 11330000, 11440000, 11550001, 'Chocoletto Slice Cake', 'Chocoletto Slice Cake', '90', '32', 23, 25, 30, 'FFLTD_SKU110063', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660066, 'Chocolate Slice Cake', 11330000, 11440000, 11550001, 'Chocolate Slice Cake', 'Chocolate Slice Cake', '35', '72', 7, 8, 10, 'FFLTD_SKU110064', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660067, 'Dry Cake  (40gm) ', 11330000, 11440000, 11550001, 'Dry Cake  (40gm) ', 'Dry Cake  (40gm) ', '40', '96', 8, 8, 10, 'FFLTD_SKU110065', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660068, 'Dry Cake (box) ', 11330000, 11440000, 11550001, 'Dry Cake (box) ', 'Dry Cake (box) ', '350', '6', 80, 90, 115, 'FFLTD_SKU110066', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660069, 'Premium Dry Cake Box', 11330000, 11440000, 11550001, 'Premium Dry Cake Box', 'Premium Dry Cake Box', '350', '6', 85, 95, 120, 'FFLTD_SKU110067', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660070, 'Swiss Cheese Cake', 11330000, 11440000, 11550001, 'Swiss Cheese Cake', 'Swiss Cheese Cake', '200', '12', 36, 40, 50, 'FFLTD_SKU110068', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660071, 'Cheese Slice Cake', 11330000, 11440000, 11550001, 'Cheese Slice Cake', 'Cheese Slice Cake', '42', '72', 8, 8, 10, 'FFLTD_SKU110069', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660072, 'Vanilla Pie', 11330000, 11440000, 11550001, 'Vanilla Pie', 'Vanilla Pie', '40', '24', 12, 13, 15, 'FFLTD_SKU110070', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660073, 'Muffin Cake', 11330000, 11440000, 11550001, 'Muffin Cake', 'Muffin Cake', '25', '72', 7, 8, 10, 'FFLTD_SKU110071', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660074, 'Play Glucose', 11330000, 11440000, 11550001, 'Play Glucose', 'Play Glucose', '11', '288', 4, 4, 5, 'FFLTD_SKU110072', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660075, 'Choconut', 11330000, 11440000, 11550001, 'Choconut', 'Choconut', '15', '144', 7, 8, 10, 'FFLTD_SKU110073', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660076, 'Choco Pie', 11330000, 11440000, 11550001, 'Choco Pie', 'Choco Pie', '36', '24', 15, 17, 20, 'FFLTD_SKU110074', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660077, 'Choco Pie Box', 11330000, 11440000, 11550001, 'Choco Pie Box', 'Choco Pie Box', '180', '10', 75, 85, 100, 'FFLTD_SKU110075', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660078, 'Fu-Wang Choco Bite', 11330000, 11440000, 11550001, 'Fu-Wang Choco Bite', 'Fu-Wang Choco Bite', '300', '6', 113, 125, 150, 'FFLTD_SKU110076', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660079, 'Doraemon Chocolate Waf.', 11330000, 11440000, 11550001, 'Doraemon Chocolate Waf.', 'Doraemon Chocolate Waf.', '20', '144', 8, 8, 10, 'FFLTD_SKU110077', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660080, 'GoGo Chocolate Car', 11330000, 11440000, 11550001, 'GoGo Chocolate Car', 'GoGo Chocolate Car', '8', '288', 4, 4, 5, 'FFLTD_SKU110078', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660081, 'Koko Chocolate Bar', 11330000, 11440000, 11550001, 'Koko Chocolate Bar', 'Koko Chocolate Bar', '16', '144', 8, 9, 10, 'FFLTD_SKU110079', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660082, 'Fu-wang Dairy Milk', 11330000, 11440000, 11550001, 'Fu-wang Dairy Milk', 'Fu-wang Dairy Milk', '16', '144', 7, 8, 10, 'FFLTD_SKU110080', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660083, 'Walkers Dairy Milk', 11330000, 11440000, 11550001, 'Walkers Dairy Milk', 'Walkers Dairy Milk', '50', '72', 25, 30, 40, 'FFLTD_SKU110081', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660084, 'Tetul Chutney ', 11330000, 11440000, 11550001, 'Tetul Chutney ', 'Tetul Chutney ', '50', '180', 7, 8, 15, 'FFLTD_SKU110082', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660085, 'Boroi Chutney', 11330000, 11440000, 11550001, 'Boroi Chutney', 'Boroi Chutney', '50', '180', 7, 8, 15, 'FFLTD_SKU110083', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660086, 'Tetul Chutney Chain', 11330000, 11440000, 11550001, 'Tetul Chutney Chain', 'Tetul Chutney Chain', '50', '120', 7, 8, 15, 'FFLTD_SKU110084', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660087, 'Boroi Chutney Chain', 11330000, 11440000, 11550001, 'Boroi Chutney Chain', 'Boroi Chutney Chain', '50', '120', 7, 8, 15, 'FFLTD_SKU110085', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660088, 'Jeera Plus', 11330000, 11440000, 11550001, 'Jeera Plus', 'Jeera Plus', '250 ml', '24', 16, 17, 20, 'FFLTD_SKU110086', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660089, 'Volt Carbonated Bev. (Non Figure)', 11330000, 11440000, 11550001, 'Volt Carbonated Bev. (Non Figure)', 'Volt Carbonated Bev. (Non Figure)', '250 ml', '24', 20, 22, 25, 'FFLTD_SKU110087', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660090, 'Pure Drinking Water', 11330000, 11440000, 11550001, 'Pure Drinking Water', 'Pure Drinking Water', '500 ml', '24', 7, 10, 15, 'FFLTD_SKU110088', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660091, 'Drinking Water', 11330000, 11440000, 11550001, 'Drinking Water', 'Drinking Water', '1500 ml', '12', 16, 18, 25, 'FFLTD_SKU110089', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660092, 'Economy Noodles Single ', 11330000, 11440000, 11550001, 'Economy Noodles Single ', 'Economy Noodles Single ', '65', '60', 12, 13, 15, 'FFLTD_SKU110090', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660093, 'Bonus Pack Noodles ', 11330000, 11440000, 11550001, 'Bonus Pack Noodles ', 'Bonus Pack Noodles ', '260', '24', 41, 45, 55, 'FFLTD_SKU110091', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660094, 'Classic Noodles ', 11330000, 11440000, 11550001, 'Classic Noodles ', 'Classic Noodles ', '520', '12', 90, 100, 125, 'FFLTD_SKU110092', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660095, 'Economy Bundle Noodles', 11330000, 11440000, 11550001, 'Economy Bundle Noodles', 'Economy Bundle Noodles', '195', '20', 40, 44, 51, 'FFLTD_SKU110093', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660096, 'Cup Noodles', 11330000, 11440000, 11550001, 'Cup Noodles', 'Cup Noodles', '100', '24', 29, 32, 40, 'FFLTD_SKU110094', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660097, 'Family Noodles', 11330000, 11440000, 11550001, 'Family Noodles', 'Family Noodles', '650', '12', 105, 115, 150, 'FFLTD_SKU110095', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660098, 'Goody 8 Pcs Noodles ', 11330000, 11440000, 11550001, 'Goody 8 Pcs Noodles ', 'Goody 8 Pcs Noodles ', '496', '12', 90, 105, 130, 'FFLTD_SKU110096', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660099, 'Goody 6 Pcs Noodles ', 11330000, 11440000, 11550001, 'Goody 6 Pcs Noodles ', 'Goody 6 Pcs Noodles ', '390', '12', 65, 72, 85, 'FFLTD_SKU110097', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660100, 'Goody Family Pack', 11330000, 11440000, 11550001, 'Goody Family Pack', 'Goody Family Pack', '780', '10', 110, 120, 160, 'FFLTD_SKU110098', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660101, 'Goody Junior', 11330000, 11440000, 11550001, 'Goody Junior', 'Goody Junior', '45', '48', 7, 8, 10, 'FFLTD_SKU110099', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11660102, 'Premium Noodles ', 11330000, 11440000, 11550001, 'Premium Noodles ', 'Premium Noodles ', '520', '12', 90, 100, 125, 'FFLTD_SKU110100', 'allImages/ProductImages/gEO2afdrk9jpg', 'Active', 'Admin', 'N', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `product_stock` (
  ...
  `product_stock_status` varchar(10) NOT NULL DEFAULT 'I'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `soc_districts` (`id`, `division_id`, `name`, `bn_name`, `lat`, `lon`) VALUES
('id', 'division_i', 'name', 'bn_name', 'lat', 'long'),
...
--
-- Table structure for table `soc_division`
--

CREATE TABLE `soc_division` (
  `id` varchar(10) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
-- Dumping data for table `soc_division`
--

INSERT INTO `soc_division` (`id`, `name`, `bn_name`, `lat`, `long`) VALUES
...
INSERT INTO `soc_thana` (`id`, `district_id`, `name`, `bn_name`) VALUES
('1', '34', 'Amtali', 'আমতলী'),
...
CREATE TABLE `user_assigned` (
  ...
  `area_code` int(11) NOT NULL,
  `user_assigned_status` varchar(10) NOT NULL DEFAULT 'N',
  `create_info` varchar(25) NOT NULL DEFAULT 'ADMIN',
  `update_info` varchar(25) NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user_assigned` (`user_assigned_id`, `user_info_id`, `area_code`, `user_assigned_status`, `create_info`, `update_info`) VALUES
(10, 11220009, 13, 'A', 'Admin', 'N'),
(11, 11220009, 14, 'A', 'Admin', 'N'),
(12, 11220009, 15, 'A', 'Admin', 'N');
...
(11220001, 'Dhali Abir', '01684924439', 'dhaliabir@soc.com', 'No Image', 'mTfetQIr', 1101000, 'Kollanpur,Dhaka', '2021-09-27 01:20:32', '', 'A'),
(11220005, 'Ashif Dhali', '01676735476', 'ashifdhali@gmail.com', 'No Image', 'mTfetQIr', 1101001, 'Kollanpur,Mirpur,Dhaka', '2021-09-29 22:23:41', '', 'A'),
(11220006, 'Rahat Mahamud', '0151256633', 'rahat@gmail.com', 'No Image', 'mTfetQIr', 1101002, 'Mirpur-12,Dhaka', '2021-09-29 22:32:09', '', 'I'),
(11220007, 'tta', '21313', '3dad', 'No Image', 'mTfetQIr', 1101001, 'aadasd', '2021-10-01 02:33:48', '', 'A'),
(11220008, 'Rahat Mahamud', '014875233', 'rahat@gmail.com', 'allImages/UserPicture/BD5amslider.jpg', 'mTfetQIr', 11110000, 'Dhaka,Bangladesh', '2021-10-03 12:49:09', '', 'A'),
(11220009, 'ARDA SO', '01315007287', 'arda.so@gmail.com', 'allImages/UserPicture/AdZCSUser_.01315007287jpg', 'mTfetQIr', 11110013, '1,Chamilibag,Santinogor', '2021-10-16 16:52:47', 'AAA', 'A'),
(11220010, 'Faruk Hasan', '0147852369', 'fark@gmail.com', 'allImages/UserPicture/46RJ5User_.0147852369jpg', '7mSf9FxdXNrmCQ==', 11110013, 'Mirpur-12,Dhaka 1216', '2021-10-16 20:42:07', 'AAA', NULL),
(11220011, 'DDD', '213232', 'Sss@gmail.com', 'allImages/UserPicture/ZcpVoUser_.213232jpg', 'mTfetQIr', 1101001, 'adasd', '2021-10-16 21:10:35', 'AAA', NULL);
...
(1101000, 'ADMIN', 'N', '0000-00-00 00:00:00'),
(1101001, 'Shop User', 'A', '0000-00-00 00:00:00'),
(1101002, 'Customer', 'A', '0000-00-00 00:00:00'),
(11110000, 'Demo User', 'A', '2021-09-13 18:24:34'),
(11110002, 'Test User Type', 'I', '2021-09-24 12:23:16'),
(11110013, 'Sales Officer', 'A', '2021-10-16 16:49:43');
...
--
-- Indexes for table `db_point_info`
--
ALTER TABLE `db_point_info`
  ADD PRIMARY KEY (`db_point_id`);
...
--
-- Indexes for table `order_info_dtl`
--
ALTER TABLE `order_info_dtl`
  ADD PRIMARY KEY (`order_info_dtl_id`);

--
-- Indexes for table `order_info_mst`
--
...
--
-- Indexes for table `user_assigned`
--
ALTER TABLE `user_assigned`
...
--
ALTER TABLE `area_info`
  MODIFY `area_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `categories`
--
ALTER TABLE `categories`
  MODIFY `categories_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11440008;

--
-- AUTO_INCREMENT for table `categories_sub`
--
ALTER TABLE `categories_sub`
  MODIFY `sub_categories_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11550006;

--
-- AUTO_INCREMENT for table `db_point_info`
--
ALTER TABLE `db_point_info`
  MODIFY `db_point_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `order_info`
  MODIFY `order_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110880024;

--
-- AUTO_INCREMENT for table `order_info_dtl`
--
ALTER TABLE `order_info_dtl`
  MODIFY `order_info_dtl_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11990632;

--
-- AUTO_INCREMENT for table `order_info_mst`
--
ALTER TABLE `order_info_mst`
  MODIFY `order_info_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11880047;

--
-- AUTO_INCREMENT for table `product_info`
--
ALTER TABLE `product_info`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11660103;
...
--
-- AUTO_INCREMENT for table `user_assigned`
--
ALTER TABLE `user_assigned`
  MODIFY `user_assigned_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `user_info`
--
ALTER TABLE `user_info`
  MODIFY `user_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11220012;

--
-- AUTO_INCREMENT for table `user_type`
--
ALTER TABLE `user_type`
  MODIFY `user_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11110014;
