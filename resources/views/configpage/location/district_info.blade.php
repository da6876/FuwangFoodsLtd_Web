                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb-holder">
                            <h1 class="main-title float-left">District Info</h1>
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item">Home</li>
                                <li class="breadcrumb-item active">District Info</li>
                            </ol>
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <span class="pull-right">
                                    ...
                                    <i class="fa fa-plus-square bigfonts"></i> Add New District Info</button>
                                </span>
                                <h3><i class="fa fa-table"></i> District Info</h3>
                            </div>
...
<script>
    ...
    var table1 = $('#userType-dataTabel').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.viewDistrictInfo') !!}',
        columns: [
            {data: 'id', name: 'id'},
