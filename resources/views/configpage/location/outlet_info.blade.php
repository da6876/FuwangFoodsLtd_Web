                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb-holder">
                            <h1 class="main-title float-left">Outlet Info</h1>
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item">Home</li>
                                <li class="breadcrumb-item active">Outlet Info</li>
                            </ol>
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <span class="pull-right">
                                    ...
                                    <i class="fa fa-plus-square bigfonts"></i> Add New Outlet Info</button>
                                </span>
                                <h3><i class="fa fa-table"></i> Outlet Info</h3>
                            </div>
...
<script>
    ...
    var table1 = $('#userType-dataTabel').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.viewOutletInfo') !!}',
        columns: [
            {data: 'outlet_id', name: 'outlet_id'},
            {data: 'shop_name', name: 'shop_name'},
            {data: 'shop_own_name', name: 'shop_own_name'},
            {data: 'mobile_no', name: 'mobile_no'},
            {data: 'address', name: 'address'},
            {data: 'db_point_status', name: 'db_point_status'},
